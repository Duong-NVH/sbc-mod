...
contract SuperBrainCapitalDaoAVAX is Ownable, IERC20 {
    ...
    ITraderJoeRouter public router = ITraderJoeRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //trader joe
    address factory = 0x9Ad6C38BE94206cA50bb0d90783181662f0Cfa10; //joe factory
    address pair; 
    ...
    constructor () {
        ...
        pair = ITraderJoeFactory(factory).createPair(WAVAX, address(this));
